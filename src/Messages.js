...
function Messages(props) {
	...
	const publishMessage = () => {
		if (props.channel) {
			...
			messaging.publish(`channels/${props.channel.id}/messages`, {type: "message", channelId: props.channel.id, id: uuidv4(), userId: user[0].userId, name: user[0].userName, avatar: user[0].image, text: text, timestamp: `${date}`});
		}
	}
